...
class CIFAR10_LT(object):
    ...
    def __init__(self, distributed, root='../data', imb_type='exp',
        ...
        train_dataset = IMBALANCECIFAR10(root=root, imb_type=imb_type, imb_factor=imb_factor,
        ...
        if test_imb_factor is not None:
            eval_dataset = IMBALANCECIFAR10(root=root, imb_type=imb_type, imb_factor=test_imb_factor,
