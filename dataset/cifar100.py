...
class IMBALANCECIFAR100(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, imb_type='exp', imb_factor=0.01, rand_number=0, train=True,
                 ...
                 download=False):
        super(IMBALANCECIFAR100, self).__init__(
...
class CIFAR100_LT(object):
    def __init__(self, distributed, root='../data', imb_type='exp',
        ...
        rand_augment_transform = RandAugment(num_ops=2, magnitude=10)
        ...
        train_dataset = IMBALANCECIFAR100(root=root, imb_type=imb_type, imb_factor=imb_factor,
        ...
        if test_imb_factor is not None:
            eval_dataset = IMBALANCECIFAR100(root=root, imb_type=imb_type, imb_factor=test_imb_factor,
                                             rand_number=0, train=False, download=True, transform=eval_transform)
        else:
