...
class iNa2018(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40):
        ...
        data_txt_root = Path(__file__).resolve().parent / "data_txt"
        train_txt = str(data_txt_root / "iNaturalist18_train.txt")
        eval_txt = str(data_txt_root / "iNaturalist18_val.txt")
