#!/usr/bin/env bash
# Stage1 — train MoE4ViT-Base on CIFAR-10 or CIFAR-100.
#
# Usage:
#   ./train_moe4vit.sh                       # defaults to cifar10
#   DATASET=cifar100 ./train_moe4vit.sh
#   ./train_moe4vit.sh cifar100 num_experts 16 top_k 4
set -euo pipefail
